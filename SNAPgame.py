...
class DECK:
    ...
    def shuffle(self):
        ...
        #--The shuffling mechanism works in this way:
        ...
        #--FOR loop. The iterable sequence for this loop is a range list with a number of indices equal to 52
        ...
        #--resulting in more shuffle operations (more system resources required) and a more thoroughly shuffled DECK object
        for count in range(52):
            ...
            #--The purpose of this IF statement is to prevent an error occurring from trying to overwrite a CARD object
    ...
    def deal(self):
        ...
        #--FOR loop. The iterable sequence for this loop is a range list with a number of indices equal to 26.
        #--The iterator variable "count" will loop through each of the integer values contained in the range list. 
    ...
    #--The purpose of the method is to return any CARD objects that are currently held in the 2 player decks or on the game board back into
    ...
    #--The method will return an empty list object that will be used to wipe any objects from the player decks and the game board before a new round
    #--begins.
    def returnCards(self, returned_cards):
        ...
        #--a player's deck or on the game board, which now need to be returned to the main deck before the next round
        for card in returned_cards:
            ...
            #--This is simulating the returning of a single card from a player deck/game board back into the main deck.
...
class CARD:
    ...
    def __str__(self):
        ...
        #--these rows contain a 10 character gap between the "|"symbols. 
...
#--Declared a list variable called "game board" that will represent the main game board for the card game. With each card that is played in a round, a card 
#--object will be appended to the "game board" list. At the end of each round, the "game board" list will be cleared
gameboard = []
...
#--Declared a new instance of a DECK class object, called "main_deck". This object will represent the main deck of 52 cards for the game.
...
#--The __init__ initializer method is called automatically when this object is instantiated. The initializer method will create the 52 CARD objects
...
#--the current CARD object on the game board matches the face value of the previous CARD object (as in a game of SNAP). This function checks 
...
def check_snap(player_number):
    ...
    #--The purpose of this IF statement is to prevent an error occurring from trying to compare 2 objects from the gameboard
    ...
    #--compare for a match.) The purpose of this ELSE statement is to compare the 2 CARD objects currently in the last 2 indices of the "gameboard"
...
def printScoreboard():
    ...
    #--1. The current score for the player is obtained by calling the "count" method on the "scoreboard" list, in order to query to number of occurrences
...
def getWinner():
    ...
    #--IF statement code block will execute if number of occurrences of the integer value 1 is more than the number of occurrences of the integer
    ...
    #--the game. The "count" method is called on the "scoreboard" list to query the number of occurrences of the passed integer values. An integer
    #--value of 1 is passed to the "count" method to query how many occurrences of 1 there are (representing the number of rounds player 1 has won), 
    ...
    #--ELSE statement code block will execute the logical opposite of the above IF statement is True, i.e if number of occurrences of the integer 
    #--value 2 is more than the number of occurrences of the integer value 1, in the "scoreboard" list variable. 
...
while (round_count < 5):
    ...
    while round_continue == True:
        ...
        #--and the most recently played card must be printed to the terminal
            ...
            #--This string has been designed in a way that resembles a real life playing card. For a more detailed description of this
        ...
        match key_pressed:
            ...
            case "D":
                ...
                #--is not integer value 1 (IF statement evaluated to false - meaning it is player 1's turn) AND if the number of items in
            ...
            case "K":
                ...
                if last_player == 2:
                    ...
                    input()
                #--ELIF statement code block will execute if the value currently assigned to the variable "last_player"
                #--is not integer value 2 (IF statement evaluated to false - meaning it is player 2's turn) AND if the number of items in
                ...
                #--the "round_count" variable will not be incremented. For a round to be over, there must be a winner
                    ...
                    round_continue = False
                #--ELSE statement code block will execute if the value currently assigned to the variable "last_player"
                #--is not integer value 2 (IF statement evaluated to false - meaning it is player 1's turn) AND if the number of items in
